...
| `DASHBOARD_NIUONE_FORWARD_COHORT_START` | `2026-08-28` | Strict-forward cohort start; archive the old protocol lock and restart from a new trading day after a rule change |
