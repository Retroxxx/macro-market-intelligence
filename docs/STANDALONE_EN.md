...
| `DASHBOARD_EXIT_FEEDBACK_MIN_SAMPLES` | `30` | Required complete five-session observations, from 20 through 500 |
| `DASHBOARD_EXIT_FEEDBACK_MIN_MONTHS` | `3` | Required observation span in months, from 2 through 12 |
| `DASHBOARD_EXIT_FEEDBACK_COOLDOWN_SAMPLES` | `10` | New complete observations required between version evaluations, from 5 through 100 |
