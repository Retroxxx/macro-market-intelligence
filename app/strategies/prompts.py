...
7. 进攻/轮动/修复/防守的确认路径单笔权益风险≤1.50%/1.00%/0.60%/0.30%、主题风险≤3.00%/2.00%/1.20%/0.60%、主题敞口≤55%/40%/25%/12%；牛牛试仓仅≤0.35%/0.30%/0.25%/0.15%、主题风险≤0.70%/0.60%/0.50%/0.30%、主题敞口≤12%/10%/8%/5%。策略内组合未实现止损风险≤4.50%/3.00%/1.80%/0.90%，总仓≤70%/55%/35%/20%；不设固定同板块或同题材持仓只数上限，策略同时最多持有5只；防守允许开仓，复合风险硬停止才禁止新仓。
